package com.example.blackhummer.u_smart.Family;
...
public class RecordListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.family_record_list);
...
//        actionBar.setTitle("Record List");
        ...
        mList = new ArrayList<>();
        mAdapter = new RecordListAdapter(this, R.layout.roww, mList);
        mListView.setAdapter(mAdapter);

        //get all data from sqlite
        Cursor cursor = FamilyActivity.mSQLiteHelper.getData("SELECT * FROM RECORD");
        mList.clear();
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, final int position, long l) {
                ...
                dialog.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if (i == 0){
                            //update
                            Cursor c = FamilyActivity.mSQLiteHelper.getData("SELECT id FROM RECORD");
    ...
    private void showDialogDelete(final int idRecord) {
        ...
        dialogDelete.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                try {
                    FamilyActivity.mSQLiteHelper.deleteData(idRecord);
    ...
    private void showDialogUpdate(Activity activity, final int position){
        ...
        dialog.setContentView(R.layout.update_family);
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    FamilyActivity.mSQLiteHelper.updateData(
                            edtName.getText().toString().trim(),
                            edtAge.getText().toString().trim(),
                            edtPhone.getText().toString().trim(),
                            FamilyActivity.imageViewToByte(imageViewIcon),
                            position
                    );
                    dialog.dismiss();
